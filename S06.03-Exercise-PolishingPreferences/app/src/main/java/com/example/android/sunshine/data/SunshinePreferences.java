...
//        return getDefaultWeatherLocation();
    ...
    public static boolean isMetric(Context context) {
        ...
        String metricKey = context.getString(R.string.pref_units_key);
        String metricValue = context.getString(R.string.pref_units_metric);
        String preferredUnits = preferences.getString(metricKey, metricValue);
        boolean userPrefersMetric;
        if (preferredUnits.equals(metricValue)) {
