...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private static final int LOADER_IDENTIFIER = 11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bundle bundle = null;
        getSupportLoaderManager().initLoader(LOADER_IDENTIFIER, bundle, callbacks);
    }
    ...
    public Loader<String[]> onCreateLoader(int i, final @Nullable Bundle args) {
        ...
        return new AsyncTaskLoader<String[]>(this) {
            String[] mWeatherResult = null; // weather data
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            getSupportLoaderManager().restartLoader(LOADER_IDENTIFIER, null, this);
            return true;
        }
